...
URL_TO_FETCH_COUNT = 20
PAGES_TO_FETCH = 20
CLUSTER_COUNT_1 = 3
CLUSTER_COUNT_2 = 6
CONCORDIA_BASE_URL = "https://www.concordia.ca"

robots_parser = RobotParser(CONCORDIA_BASE_URL)
urls = link_crawler(CONCORDIA_BASE_URL, URL_TO_FETCH_COUNT, robots_parser)
html_crawler = HtmlCrawler(robots_parser)
html_documents = html_crawler.fetch_concordia_internal_links_html(PAGES_TO_FETCH)
